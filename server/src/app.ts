...
import { PORT, HOST, NODE_ENV } from "./config/env-variables.js";
...
app.use(cors(), helmet(), express.static("../../client/dist/"), express.text());

app.post("/api/shorten-url", shortenURLHandler);
app.get("/:shortenedPath", redirectURLHandler);
